       ...
       FILE-CONTROL.
           ...
           SELECT ACCT-REC   ASSIGN ACCTREC
                             STATUS ACCT-ST.
      *status durumunu kontrol etmek icin
       DATA DIVISION.
       ...
       H200-PROCESS.
000018     COMPUTE DATE-INT = FUNCTION INTEGER-OF-DATE(ACCT-BDATE)
000018     COMPUTE NDATE-INT = FUNCTION INTEGER-OF-DATE(ACCT-TODAY)
